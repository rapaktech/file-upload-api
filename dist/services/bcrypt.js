...
var hashPassword = function (unhashedPassword) { return __awaiter(void 0, void 0, void 0, function () {
    var hash;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, bcrypt_1["default"].hash(unhashedPassword, saltRounds)];
            case 1:
                hash = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, isValidPassword];
        }
    });
}); };
